...
<!--         <script src='../www.google.com/recaptcha/api.js'></script> -->
        <title>Sambole.lk - Ops! You're in a Wrong Place.</title>
                ...
                <div class="container-floud">
                    <div class="col-xs-12 ground-color text-center">
                        <div class="container-error-404">
                             <h4 class="h1">DEVELOPERS ONLY.</h4>
                        </div>
                        <h2 class="h1">The page you are looking is not found.</h2>

                        <a href="{{url('/')}}" class="btn submit-form">Back to Home</a>
                    </div>
                </div>
            </div>
        <!-- Error Page -->
