  ...
  <li class="nav-header">
    <div class="dropdown profile-element text-center">
        <span>
            ...
            <img alt="image" style="width: 100px;" class="img-circle" src="{{asset('assets/front/images/sambole-logo.png')}}" />
            @else
        ...
        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
            <span class="clear"> <span class="block m-t-xs"> <strong class="font-bold">{{$loggedUser->username}}</strong>
            </span> <span class="text-muted text-xs block">{{$loggedUser->roles[0]['name']}}</span> </span> </a>
