...
<body>
            ...
            <div class="navbar-header">
              ...
              <!--   <form role="search" class="navbar-form-custom" action="">
                ...
                <ul class="nav navbar-top-links navbar-right">
                    <li>
                        <span class="m-r-sm text-muted welcome-message">Welcome to KIKI CMS  Admin Portal.</span>
                    </li>
    ...
    <script src="{{asset('assets/back/Tree-Plugin-jQuery-jsTree/dist/jstree.min.js')}}"></script>
    <script src="{{asset("assets/back/parsleyjs/parsley.min.js")}}"></script>
     ...
     function confirmAlert(id) {
        swal({
           ...
           if (isConfirm) {
                ...
                swal("Cancelled", "Cancelled the deleting", "error");
            }
        });
    }
