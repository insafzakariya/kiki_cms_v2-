@extends('layouts.back.master') @section('current_title','Song Composer/ADD')
@section('css')
    ...
    <div class="row">
        <div class="col-lg-12 margins">
            <div class="ibox-content">
                ...
                <form method="POST" class="form-horizontal" id="form" action="{{route('admin.song-composers.store')}}"
                    ...
                    <div class="form-group">
                        <div class="col-sm-8 col-sm-offset-2">
                            <button class="btn btn-default" type="button" onclick="location.href = '{{url('admin/song-composers')}}'">Cancel</button>
