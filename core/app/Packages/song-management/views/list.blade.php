...
{{--    @if(\Sentinel::getUser()->hasAnyAccess(['admin.projects.show', 'admin']))--}}
        <div id="floating-button" data-toggle="tooltip" data-placement="left" data-original-title="Create" onclick="location.href = '{{url('admin/song/step-1')}}';">
            <p class="plus">+</p>
        </div>
{{--    @endif--}}
    <div class="row">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function(){
            ...
            table=$('#example1').DataTable( {
                ...
                columns:[
                    {name :  'songId', data :  'songId'},
                    {name : 'name', data : 'name'} ,
                    {name : 'isbc_code', data : 'isbc_code'} ,
                    {name : 'artist_name', data : 'artist_name', defaultContent: "-", 'orderable' : false, 'searchable' : false} ,
                    {name : 'songs_categories.name', data : 'category_name', defaultContent: "-", 'orderable' : false, 'searchable' : false} ,
                    {name : 'genre_name', data : 'genre_name', defaultContent: "-" , 'orderable' : false, 'searchable' : false} ,
                    {name : 'songs_publishers.name', data : 'publisher_name', 'orderable' : false, 'searchable' : false},
                    {name : 'product_name', data : 'product_name', defaultContent: "-", 'orderable' : false, 'searchable' : false} ,
                    {name : 'track', data : 'track_download'} ,
        ...
        function changeStatus(id, state) {
            swal({
                ...
                if (isConfirm) {
                    $.ajax({
                        method: "POST",
                        url: '{{url('admin/song/changeState')}}',
