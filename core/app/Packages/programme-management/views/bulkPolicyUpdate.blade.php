...
@section('page_header')
 <div class="col-lg-9">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">
            <strong>Programme - Episode / Bulk Policy Update</strong>
        </li>
    </ol>
</div>                  
@stop
        ...
        <div class="ibox-content">
                ...
                <form method="POST" class="form-horizontal" id="form"  enctype="multipart/form-data">
                    ...
                    <div class="form-group"><label class="col-sm-2 control-label">Details </label>
                        ...
                        <a class="badge badge-warning">Programme Name : {{$programme->programName}} [{{($programme->programId)}}] </a>
                        <a class="badge badge-success">Episode Count :{{$episode_count}} episodes Found</a>
