@extends('layouts.back.master') @section('current_title','Lyricist/ADD')
@section('css')
    ...
    <div class="row">
        <div class="col-lg-12 margins">
            <div class="ibox-content">
                ...
                <form method="POST" class="form-horizontal" id="form" action="{{route('admin.lyricists.store')}}" enctype="multipart/form-data" data-parsley-validate>
                    {!!Form::token()!!}

                    <div class="form-group"><label class="col-sm-2 control-label">Name <label class="text-danger">*</label></label>
                        <div class="col-sm-10"><input type="text" class="form-control" name="name" required data-parsley-required-message="Name field is required"></div>
                    </div>
