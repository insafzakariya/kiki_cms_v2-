                   ...
                   <div class="form-group"><label class="col-sm-2 control-label">PRODUCT NAME</label>
                    ...
                    <div class="form-group"><label class="col-sm-2 control-label">DESCRIPTION</label>
                     ...
                     <div class="form-group"><label class="col-sm-2 control-label">CATEGORY</label>
                         <div class="col-sm-10">
                            <select class="js-source-states form-control" name="category" style="width: 100%">                            
                            <?php foreach ($main_category as $key => $value): ?>
                                <optgroup label="{{$value['main_category']['name']}}">
                                    <?php foreach ($value['sub_categories'] as $key => $sub_value): ?>
                                        <?php if ($sub_value['id']==$product->category_id): ?>
                                            <option value="{{$sub_value['id']}}" selected="">{{$sub_value['name']}}</option>
                                        <?php else: ?>
                    ...
                    <div class="form-group"><label class="col-sm-2 control-label">PRICE</label>
                        <div class="col-sm-5"><input type="text" class="form-control" value="{{number_format($product->price,2)}}" name="price"></div>
                    </div>
