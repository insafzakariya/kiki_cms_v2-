...
@stop
@section('content')
<?php if (!Sentinel::hasAnyAccess($permissions)): ?>
  <div id="floating-button" data-toggle="tooltip" data-placement="left" data-original-title="Create" onclick="location.href = '{{url('product/add')}}';">
    <p class="plus">+</p>   
</div>
<?php endif ?>
             	...
             	<table id="example1" class="table table-striped table-bordered table-hover dataTables-example" width="100%">
                    <thead>
                      <tr>
                          ...
                          <th rowspan="2"  width="5%" > QTY on Hand</th>                        
                          <th rowspan="2" width="2%"> Status</th>                        
