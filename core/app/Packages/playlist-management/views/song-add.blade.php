    ...
    <div class="row">
        <div class="col-lg-12 margins">
            <div class="ibox-content">
                ...
                <div class="steps-form" style="margin-bottom: 20px;">
                ...
                <div style="margin-bottom: 80px;">
                    <div class="form-inline">
                        ...
                        <div class="checkbox-inline">
                            <input type="radio" class="form-check-input" id="diabetes" name="type" checked="checked"
                                   value="artist">
                    ...
                    <div class="form-group form-inline" style="margin-top: 30px; margin-bottom: 20px">
                        <label class="control-label" style="margin-right: 35px; margin-left: 15px">Search </label>
                ...
                <button type="button" id="addSelected" onclick="confirmAddSongs()" class="btn btn-info"
                        style="float: right;">Add Selected
                </button>
                ...
                <div style="margin-top: 30px">
                    <button id="removeSelected" onclick="confirmRemoveSongs()" class="btn btn-info"
                            style="float: right;">Remove Selected
                    </button>
                ...
                <div class="form-group" style="    padding: inherit;">
                    <div class="col-sm-8 col-sm-offset-2">
                        <a class="btn btn-default" href="{{url("/admin/playlist/step-1?id=".$id)}}"
                           style="width: 100px; margin-right: 10px;">Back</a>
                        <button class="btn btn-primary" type="button" onclick="saveSongs()" style="width: 100px;">Next
                        </button>
                    </div>
                </div>
            </div>
...
@section('js')
    ...
    <script type="text/javascript">
        ...
        //         $('#example1').DataTable().draw(true);
        //     } else {
        //         toastr.error("Please enter the keyword");
        //     }
        // });
        ...
        function saveSongs() {
            ...
            if (itemArray.length > 0) {
                $.ajax({
                    method: "POST",
                    url: "{{url('admin/playlist/step-2')}}",
                    data: {
                        'songs': itemArray,
                        "id": "{{$id}}"
                    }
                }).done(function (msg) {
                    window.location = "step-3?id={{$id}}";
                });
            } else {
