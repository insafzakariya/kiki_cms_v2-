        ...
        <div class="ibox-content">
            ...
            <form method="POST" class="form-horizontal" id="form">
                ...
                <div class="form-group"><label class="col-sm-2 control-label">FIRST NAME <span class="required">*</span></label>
                   ...
                   <div class="col-sm-10"><input type="text" name="first_name" class="form-control" value="{{old('first_name')}}"></div>
               </div>
               <div class="form-group"><label class="col-sm-2 control-label">LAST NAME <span class="required">*</span></label>
                   <div class="col-sm-10"><input type="text" name="last_name" class="form-control" value="{{old('last_name')}}"></div>
               </div>
                ...
                <div class="form-group"><label class="col-sm-2 control-label">EMAIL <span class="required">*</span></label>
                    <div class="col-sm-10"><input type="text" name="username" class="form-control" value="{{old('username')}}"></div>
                </div>
